...
interface BitcoinFaceLogoProps {
  width: string;
  height: string;
}

const BitcoinFaceLogo: React.FC<BitcoinFaceLogoProps> = ({ width, height }) => {
  return (
    <svg
      ...
      <g style={{ isolation: "isolate" }}>
        ...
        <g id="Body-6">
          ...
          <rect
            ...
            width="211.14"
            height="314.83"
            style={{ fill: "#7814bc", opacity: 0.64, mixBlendMode: "multiply" }}
          />
          <path
        ...
        <g id="Head-9">
          <path
            d="M500.1,140.7h0c187.52,0,348.53,152,348.53,339.53V716.86H496"
            transform="translate(9.03 13)"
            style={{ fill: "#727fbd" }}
          />
          <path
            d="M513.51,140.45h-9C317,140.45,165,292.46,165,480V716.86H506.8"
            transform="translate(9.03 13)"
            style={{ fill: "#aaaecc" }}
          />
          <path
          ...
          />
          <path
            d="M506.8,844.21H407.58A294.75,294.75,0,0,1,165,716.86H506.8Z"
            transform="translate(9.03 13)"
            style={{ fill: "#aaaecc" }}
          />
        </g>
        ...
        <g id="Ears-4">
          <path
            d="M366.21,205.76l-126-84-33.41,41.76a74.23,74.23,0,0,0,16.79,108.13l58.61,39.07"
            transform="translate(-1.66 0)"
            style={{ fill: "#883a62" }}
          />
          <path
            d="M646.07,205.43l126-84,33.41,41.77a74.21,74.21,0,0,1-16.78,108.12l-58.62,39.08"
            transform="translate(-1.66 0)"
            style={{ fill: "#4d2f47" }}
          />
        </g>
        <g id="Mouth-6">
          ...
          <rect
            ...
            width="195.45"
            height="100.83"
            transform="translate(1197.35 1204.78) rotate(-180)"
            style={{ fill: "#f46461" }}
          />
          <rect
            x="495.41"
            ...
            width="176.56"
            height="75.62"
            transform="translate(1165.84 1204.78) rotate(-180)"
            style={{ fill: "#efe1da" }}
          />
          <rect
            x="634.16"
            ...
            width="12.6"
            height="75.62"
            transform="translate(1279.37 1204.78) rotate(-180)"
            style={{ fill: "#001a1b" }}
          />
          <rect
            x="596.35"
            ...
            width="12.6"
            height="75.62"
            transform="translate(1203.75 1204.78) rotate(-180)"
            style={{ fill: "#001a1b" }}
          />
          <rect
            x="558.5"
            ...
            width="12.6"
            height="75.62"
            transform="translate(1128.06 1204.7) rotate(-180)"
            style={{ fill: "#001a1b" }}
          />
          <rect
            x="520.69"
            ...
            width="12.6"
            height="75.62"
            transform="translate(1052.44 1204.7) rotate(-180)"
            style={{ fill: "#001a1b" }}
          />
          <rect
            x="329.85"
        ...
        <g id="Glasses-3">
          ...
          />
          <path
            d="M220.55,460.37H468.09a0,0,0,0,1,0,0v0A123.77,123.77,0,0,1,344.32,584.14h0A123.77,123.77,0,0,1,220.55,460.37v0A0,0,0,0,1,220.55,460.37Z"
            style={{
              fill: "#8e97c4",
          ...
          />
          <path
            d="M549.46,459.23H797a0,0,0,0,1,0,0v0A123.77,123.77,0,0,1,673.23,583h0A123.77,123.77,0,0,1,549.46,459.23v0A0,0,0,0,1,549.46,459.23Z"
            style={{
              fill: "#8e97c4",
              opacity: 0.5700000000000001,
              mixBlendMode: "color-dodge",
        ...
        <g id="Eyes-1">
          ...
          />
          <polyline
            points="368.03 393.26 368.03 428.94 399.25 397.72"
            style={{ fill: "#efe1da" }}
          />
          <circle
            cx="363.78"
          ...
          />
          <polyline
            points="653.4 390.36 653.4 426.04 684.63 394.82"
            style={{ fill: "#efe1da" }}
          />
          <circle
            cx="649.15"
          ...
          />
          <path
            d="M545.77,432V375.9a96,96,0,0,1,96-96h18.07"
            transform="translate(0.28 0)"
            style={{
              fill: "none",
              strokeLinecap: "round",
          ...
          />
          <path
            d="M528.38,432.45V368A110.38,110.38,0,0,1,638.76,257.57h20.78"
            transform="translate(0.28 0)"
            style={{
              fill: "none",
              strokeLinecap: "round",
          ...
          />
          <path
            d="M459.43,432.32V380a89.59,89.59,0,0,0-89.59-89.59H353"
            transform="translate(0.28 0)"
            style={{
              fill: "none",
              strokeLinecap: "round",
          ...
          />
          <path
            d="M467.36,432V375.9a96,96,0,0,0-96-96H353.32"
            transform="translate(0.28 0)"
            style={{
              fill: "none",
              strokeLinecap: "round",
          ...
          />
          <path
            d="M484.75,432.45V368A110.38,110.38,0,0,0,374.37,257.57H353.59"
            transform="translate(0.28 0)"
            style={{
              fill: "none",
              strokeLinecap: "round",
          ...
          />
          <polyline
            points="720.19 379.63 806.03 448.31 720.19 448.31"
            style={{ fill: "#001a1b" }}
          />
          <polyline
            points="295.05 379.63 209.21 448.31 295.05 448.31"
            style={{ fill: "#001a1b" }}
          />
        </g>
        <g id="Nose-5">
          <polyline
            points="464.53 419.86 439.16 525.62 506.81 525.62 506.81 404.19"
            style={{ fill: "#f9c1c0" }}
          />
          <polygon
            points="439.16 525.62 506.81 525.62 506.81 541.29 439.16 525.62"
            style={{ fill: "#f9c1c0" }}
          />
          <path
            d="M438.82,525.62h0c11,12.76,30.12,23.67,54.81,31.29l12.84,4V541.29Z"
            transform="translate(0.34)"
            style={{ fill: "#883a62" }}
          />
          <polyline
            points="548.99 419.67 574.36 525.44 506.7 525.44 506.7 404"
            style={{ fill: "#f489ae" }}
          />
          <polygon
            points="574.36 525.44 506.7 525.44 506.7 541.11 574.36 525.44"
            style={{ fill: "#f489ae" }}
          />
          <path
            d="M574,525.44h0c-11,12.75-30.13,23.66-54.81,31.28l-12.85,4V541.11Z"
            transform="translate(0.34)"
            style={{ fill: "#4d2f47" }}
          />
        </g>
        <g id="Hat-1">
          <path
            d="M498,50h9a0,0,0,0,1,0,0V185a0,0,0,0,1,0,0H363a0,0,0,0,1,0,0v0A135,135,0,0,1,498,50Z"
            style={{ fill: "#f96020" }}
          />
          <path
            d="M507,50h9A135,135,0,0,1,651,185v0a0,0,0,0,1,0,0H507a0,0,0,0,1,0,0V50A0,0,0,0,1,507,50Z"
            style={{ fill: "#d74816" }}
          />
          <rect
            x="391"
...
export default BitcoinFaceLogo;
